  ...
  return (
    <section className="w-full">
      <div className="max-w-[80vw] mx-auto min-h-[90vh] py-8">
        ...
        <section className="flex flex-col md:flex-row gap-6 w-full px-4">
          {skills.programming.map((group, index) => (
            <div key={group.category} className="flex-1 basis-0 min-w-0 rounded-md bg-stone-200 dark:bg-zinc-800 p-5">
